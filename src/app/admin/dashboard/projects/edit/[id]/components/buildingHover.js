...
export default function BuildingHover({ imageUrl, hoverImageChange, imageDelete }) {
    return (
        <div className='flex flex-col justify-center items-center gap-5 p-5 px-10 border className= dark-theme w-full'>
            {imageUrl && (
                <>
                    <Image
                        src={imageUrl}
                        alt="Project buildingHoverImage"
                        width={150}
                        height={150}
                        quality={100}
            ...
            <div className='flex gap-2 '>
                <label htmlFor="buildingHoverImage" className="text-sm mb-2 cursor-pointer bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded flex">
                    ...
                    Building Hover Image
                </label>
                <input
                    type="file"
                    id="buildingHoverImage"
                    name="buildingHoverImage"
                    onChange={hoverImageChange}

          ...
          memoizedPressReleaseData.map(
            ({ index, imageUrl, content, heading, redirection }) => (
              <div
                ...
                key={index}
                className={`grid grid-cols-1 md:grid-cols-[40%_auto] z-1 gap-10 justify-stretch w-full items-center pt-24 pb-4 px-4 ${
              ...
              >
                ...
                <div className="z-20 md:z-0 flex flex-col justify-center items-center w-full ">
                  ...
                  >
                    <h2 className="text-2xl font-bold text-[#fef6ed] text-opacity-75">
                      {heading}
                    </h2>
                    <p
                      className="text-justify w-full text-[#fef6ed] text-opacity-75"
